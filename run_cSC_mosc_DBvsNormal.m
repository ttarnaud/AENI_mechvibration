...
% compare results obtained via normal method and Database-method. 
% script needs to be checked before results are interpreted (changes were
% made to functions)
if ~isdeployed
clear all
close all
